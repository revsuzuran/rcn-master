            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                  ...
                  <a href="<?php echo base_url('rekon_transaksi/add_compare');?>" class="btn btn-primary">Next</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-12">
                <div class="card mb-4">
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-danger">
                    ...
                    <a href="<?php echo base_url('rekon_transaksi/cleansing_data/all');?>" class="btn btn-sm btn-light me-md-2">Show All Data</a>
