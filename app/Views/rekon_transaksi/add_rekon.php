...
<div class="container-fluid" id="container-wrapper">
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo base_url('rekon_transaksi/upload'); ?>" id="uploadForm">
    <div class="row mb-3">
...
<script>
  ...
  $("#submitProses").on("click", function(e) {
    e.preventDefault();
    $('#uploadForm').attr('action', "<?php echo base_url('rekon_transaksi/upload_with_setting'); ?>").submit();
  });
