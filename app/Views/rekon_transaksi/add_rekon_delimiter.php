...
<div class="container-fluid" id="container-wrapper">
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo base_url('rekon_transaksi/save_delimiter'); ?>">
    <div class="row mb-3">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php if ($_SESSION['tipe'] == "2") { ?>
                        <a class="btn btn-danger me-md-2" href="<?php echo base_url('rekon_transaksi/add_rekon_next');?>">Kembali</a>
                        <?php } else {  ?>
                        <a class="btn btn-danger me-md-2"  href="<?php echo base_url('rekon_transaksi/add');?>">Kembali</a>
                        <?php }  ?>
