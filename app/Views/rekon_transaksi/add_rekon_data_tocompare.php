...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <div class="row mb-3">
        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('rekon_transaksi/save_cleansing'); ?>">
                  ...
                  <div class="card mb-4">
                      ...
                      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <?php if ($_SESSION['tipe'] == "2") {
                          ...
                          <a href="<?php echo base_url('rekon_transaksi/cleansing_data');?>" class="btn btn-danger">Kembali</a>  
                          <!-- <a href="<?php echo base_url('rekon_transaksi/rekon_preview');?>" class="btn btn-warning">Next (Preview Data)</a> -->
                        ...
                        <?php } else {  ?>
                          ...
                          <a href="<?php echo base_url('rekon_transaksi/cleansing_data');?>" class="btn btn-danger">Kembali</a>  
                          <!-- <a href="<?php echo base_url('rekon_transaksi/add');?>" class="btn btn-primary">Next (Data #2)</a> -->
                          <button type="button" class="btn btn-secondary btnNext" data-bs-toggle="modal" data-bs-target="#staticBackdrop" >
                              Next (Data #2)
                          </button>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <!-- <form method="post" enctype="multipart/form-data" action="<?php echo base_url('rekon_transaksi/upload_with_setting'); ?>"> -->
...
<script>
  ...
  $("#btnNextOk").on("click", function() {
    ...
    if(sess == "1") {
      window.location.replace("<?= base_url('rekon_transaksi/add_rekon_next') ?>")
    } else {
      window.location.replace("<?= base_url('rekon_transaksi/rekon_preview') ?>")
    }
  });
  ...
  $("#addCompare").click(function() {
        ...
        console.log(idt);
        $.ajax({
            url : "<?= base_url('rekon_transaksi/add_kolom_compare') ?>",
            method : "POST",
  ...
  $(".rmCompare").click(function() {
      ...
      console.log(idt);
      $.ajax({
          url : "<?= base_url('rekon_transaksi/rm_kolom_compare') ?>",
          method : "POST",
  ...
  $(".rmSum").click(function() {
      ...
      $.ajax({
          url : "<?= base_url('rekon_transaksi/rm_kolom_sum') ?>",
          method : "POST",
          data : {"rekon_index": indx, "rekon_name": nme},
          async : true,
          success: function($result){
  ...
  $("#addSum").click(function() {      
      ...
      console.log(idt);
      $.ajax({
          url : "<?= base_url('rekon_transaksi/add_kolom_sum') ?>",
          method : "POST",
          data : {"rekon_index": id, "rekon_name": idt},
          async : true,
          success: function($result){
