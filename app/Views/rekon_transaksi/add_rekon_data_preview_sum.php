...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <div class="row mb-3">               
          <!-- Tables -->
          <div class="col-lg-12">
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('rekon_transaksi/save_compare_sum'); ?>">
                <div class="card mb-4">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                          ...
                          <a href="<?php echo base_url('rekon_transaksi/rekon_preview');?>" class="btn btn-danger">Kembali</a>  
                          <a class="btn btn-primary" href="<?php echo base_url('rekon_transaksi/add_rekon_finish');?>">Finish</a>
                        </div>
...
<script>
  ...
  $("#btnNext").click(function() {
      ...
      console.log(idt);
      $.ajax({
          url : "<?= base_url('rekon_transaksi/save_compare_sum') ?>",
          method : "POST",
