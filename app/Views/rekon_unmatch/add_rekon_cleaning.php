...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <div class="row mb-3">
        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('rekon_unmatch_bulanan/save_cleansing'); ?>">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                  ...
                  <a href="<?php echo base_url('rekon_unmatch_bulanan/add_compare');?>" class="btn btn-primary">Next</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-12">
                <div class="card mb-4">
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-danger">
                    ...
                    <a href="<?php echo base_url('rekon_unmatch_bulanan/cleansing_data/all');?>" class="btn btn-sm btn-light me-md-2">Show All Data</a>
                  </div>
