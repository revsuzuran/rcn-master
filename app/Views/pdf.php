                ...
                <td class="text-align: left">
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td>Total Data</td>
                                <td>: <?= $data_rekon_satu->compare_result->total_data; ?></td>
                            </tr>
                            <tr>
                                <td>Total Match</td>
                                <td>: <?= $data_rekon_satu->compare_result->total_match; ?></td>
                            </tr>
                            <tr>
                                <td>Total UnMatch</td>
                                <td>: <?= $data_rekon_satu->compare_result->total_unmatch; ?></td>
                            </tr>
                        </tbody>
                    </table>  
                </td>
                <td style="vertical-align:top">
                    <table align="right">
                        <tbody>
                            ...
                            <tr>
                                <td><?= "Total "?></td>
                                <td><?= ": " .rupiah((isset($data_rekon_satu->sum_result->total_sum) ? $data_rekon_satu->sum_result->total_sum : 0)); ?></td>
                            </tr>
                            <tr>
                                <td><?= "Total Match" ?></td>
