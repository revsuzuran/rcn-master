            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="nama_bank" type="text" class="form-control" placeholder="Bank Mandiri" value="<?= $data_bank->nama_bank ?>" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">No Rekening</label>
                        <input id="norek" type="text" class="form-control" value="<?= $data_bank->norek ?>" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Kode Bank</label>
                        <input id="kode_bank" type="text" class="form-control" value="<?= $data_bank->kode_bank ?>" required>
                    </div>
