            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="nama_mitra" type="text" class="form-control" placeholder="Mitra LinkQu" value="" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="uname" type="text" class="form-control" value="">
                    </div>
